...
class Metaclass_FFMPEGPacket(type):
    """Metaclass of message 'FFMPEGPacket'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('ffmpeg_image_transport_msgs')
        except ImportError:
            import logging
            import traceback
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__ffmpeg_packet
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__ffmpeg_packet
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__ffmpeg_packet
            cls._TYPE_SUPPORT = module.type_support_msg__msg__ffmpeg_packet
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__ffmpeg_packet
...
class FFMPEGPacket(metaclass=Metaclass_FFMPEGPacket):
    """Message class 'FFMPEGPacket'."""
    ...
    def pts(self, value):
        if __debug__:
            ...
            assert value >= 0 and value < 18446744073709551616, \
                "The 'pts' field must be an unsigned integer in [0, 18446744073709551615]"
        self._pts = value
