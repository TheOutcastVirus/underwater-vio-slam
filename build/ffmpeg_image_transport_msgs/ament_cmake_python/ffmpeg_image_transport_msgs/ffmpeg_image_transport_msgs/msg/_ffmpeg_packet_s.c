...
bool ffmpeg_image_transport_msgs__msg__ffmpeg_packet__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ffmpeg_image_transport_msgs.msg._ffmpeg_packet.FFMPEGPacket", full_classname_dest, 59) == 0);
  }
  ffmpeg_image_transport_msgs__msg__FFMPEGPacket * ros_message = _ros_message;
  {  // header
  ...
  {  // pts
    ...
    assert(PyLong_Check(field));
    ros_message->pts = PyLong_AsUnsignedLongLong(field);
    Py_DECREF(field);
  }
  {  // flags
...
{
  /* NOTE(esteve): Call constructor of FFMPEGPacket */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ffmpeg_image_transport_msgs.msg._ffmpeg_packet");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FFMPEGPacket");
  ...
  {  // pts
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLongLong(ros_message->pts);
    {
