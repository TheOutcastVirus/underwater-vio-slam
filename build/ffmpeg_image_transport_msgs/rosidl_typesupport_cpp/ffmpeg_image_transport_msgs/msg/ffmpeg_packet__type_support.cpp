...
static const _FFMPEGPacket_type_support_symbol_names_t _FFMPEGPacket_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ffmpeg_image_transport_msgs, msg, FFMPEGPacket)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ffmpeg_image_transport_msgs, msg, FFMPEGPacket)),
  }
};
...
{
  return &::ffmpeg_image_transport_msgs::msg::rosidl_typesupport_cpp::FFMPEGPacket_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ffmpeg_image_transport_msgs, msg, FFMPEGPacket)() {
  return get_message_type_support_handle<ffmpeg_image_transport_msgs::msg::FFMPEGPacket>();
}
